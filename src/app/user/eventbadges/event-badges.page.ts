...
import { EventBadgesModel } from './event-badges.model';
...
export class EventBadgesPage implements OnInit {
  data: EventBadgesModel;
        ...
        promiseObservable.subscribe(promiseValue => {
          ...
          if (dataObservable) {
            dataObservable.subscribe(observableValue => {
              const pageData: EventBadgesModel = observableValue;
              ...
              if (pageData) {
                this.data = pageData;
                this.eventsList = this.data.events;
              }
            });
          } else {
  ...
  searchList(): void {
    ...
    this.eventsList = this.filterList(this.data.events, query);
  }
